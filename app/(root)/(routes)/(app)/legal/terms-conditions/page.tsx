  ...
  return (
    <div className="flex flex-col text-white max-w-7xl w-full px-10 mx-auto">
      <div className="flex flex-col mb-4">
        <h1 className="text-center fw-bold h1">Terms and conditions</h1>
        <p className="page_speed_1407344827">
          <strong>
            {" "}
            DATE OF LAST REVISION: <span id="date">18 March 2024</span>
          </strong>
        </p>
        <p>
          <strong>
            <span className="h3">
              Welcome to <span className="website_name">TubeMindSync</span>!
            </span>
          </strong>
        </p>
        <p className="brz-tp-paragraph">
          ...
          if you do not agree with all of the terms and conditions stated on
          this page.
        </p>
        <p className="brz-tp-paragraph">
          ...
          <strong className="company_country">Romania</strong>. Any use of the
          above terminology or other words in the singular, plural,
          capitalization and/or he/she or they, are taken as interchangeable and
          therefore as referring to same.
        </p>
        <p>
          <strong className="page_speed_28922724">Cookies</strong>
        </p>
        <p className="brz-tp-paragraph">
        ...
        <p>
          <strong className="page_speed_28922724">
        ...
        <p className="brz-tp-paragraph">
          ...
          material on{" "}
          <strong className="website_url">tubemindsync.vercel.app</strong>. This
          website and its contents are protected by copyright, trademark, and
          other laws of <strong className="company_country">Romania</strong>,
          and/or foreign countries. We and our licensors reserve all rights not
          expressly granted under these Terms of Use.
        </p>
        <p className="brz-tp-paragraph">
          You may access this website for your own personal use subject to
          restrictions set in these terms and conditions.
        </p>
        <p className="brz-tp-paragraph">You must not:</p>
        <ul>
          <li>
            Republish material from{" "}
            <span>
              <strong className="website_url">tubemindsync.vercel.app</strong>
            </span>
            ;
          </li>
          <li>
            Use material from{" "}
            <strong className="website_url">tubemindsync.vercel.app</strong> for
            commercial purposes;
          </li>
          <li>
          ...
          <li>
            Reproduce, duplicate, modify or copy material from{" "}
            <strong className="website_url">tubemindsync.vercel.app</strong>;
          </li>
          <li>
        ...
        <p className="brz-tp-paragraph">
          ...
          material or media, whether in written, oral, electronic, visual, or
          any other form, except if expressly permitted in writing by{" "}
          <strong className="website_name company_name">Tube Mind Sync</strong>.
        </p>
        <p className="brz-tp-paragraph">
        ...
        <p>
          <strong className="page_speed_28922724">Your Privacy</strong>
        </p>
        <p className="brz-tp-paragraph">
        ...
        <p>
          <strong className="page_speed_28922724">Reservation of Rights</strong>
        </p>
        <p className="brz-tp-paragraph">
        ...
        <p>
          ...
          not only to us but also to our personnel and subcontractors.
        </p>
        <p>
          The above disclaimers and limitations of liability are applicable to
          the fullest extent permitted by law, whether in contract, statute,
